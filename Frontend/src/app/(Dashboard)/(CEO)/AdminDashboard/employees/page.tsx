            ...
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">18</h3>
                </div>
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full lg:w-auto">
                  <select 
                    ...
                    className="px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-auto"
                  >
                ...
                {(searchTerm || departmentFilter || statusFilter || sortBy) && (
                  <button
                    ...
                    className="px-3 sm:px-4 py-2 text-sm sm:text-base text-gray-600 hover:text-gray-800 flex items-center gap-2 w-full sm:w-auto justify-center lg:justify-start"
                  >

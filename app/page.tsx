            ...
            <div className="pt-10 sm:pt-16 lg:pt-8 lg:pb-14 xl:pt-16 xl:pb-21">
              <div className="sm:text-center lg:text-left px-4 sm:px-8 xl:pl-0">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600">Remote Company Management</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Efficiently manage your remote team, track productivity, and foster collaboration 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need to manage your remote team
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Powerful tools and features to help you manage your remote team effectively.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Easily manage your remote team members, their roles, and responsibilities.',
                  icon: (
                ...
                },
                {
                  ...
                  description: 'Monitor and improve team productivity with real-time analytics and insights.',
                  icon: (
                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                },
                {
                  ...
                  description: 'Built-in tools for seamless communication and collaboration.',
                  icon: (
                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                },
                {
                  ...
                  description: 'Organize and track projects with our intuitive project management tools.',
                  icon: (
                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
